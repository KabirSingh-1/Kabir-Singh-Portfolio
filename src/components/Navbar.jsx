...
//     ? 'bg-neutral-900/50 backdrop-blur-xl border border-neutral-700/30'
//     : 'bg-transparent';
...
//         {/* Desktop Menu */}
//         <ul className="hidden sm:flex flex-row gap-10 relative">
//           {navLinks.map((link) => (
...
//                 <motion.span
//                   layoutId="underline"
//                   className="absolute left-0 bottom-[-4px] h-[2px] w-full bg-violet-500"
